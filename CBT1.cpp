...
int main(){
    int arr[]={10,30,20,50,40,10,20,50,20,30,20,20,10,40,60,80,40,20,20,20,60,};
    int n=sizeof(arr)/sizeof(arr[0]);

    sort(arr , arr+n);
    int maxCount=1,maxNum=arr[0];
    int currCount=1, currNum=arr[0];
    for(int i=1; i<n; i++){
        if(arr[i]==currNum){
            currCount++;
        }
    ...
    cout<<"Highest Number: "<<maxNum<<endl;
